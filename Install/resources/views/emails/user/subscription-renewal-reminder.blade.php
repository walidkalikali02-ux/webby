...
@section('content')
    <h2 style="margin: 0 0 20px; font-size: 20px; font-weight: 600; color: #18181b;">
        {{ __('Subscription Renewal Reminder') }}
    </h2>
    ...
    @include('emails.partials.details-box', [
        ...
        'details' => [
            __('Plan') => $planName,
            __('Expiration Date') => $expirationDate
        ],
        'primaryColor' => $primaryColor
    ])

    <p style="margin: 0 0 16px; font-size: 15px; line-height: 24px; color: #3f3f46;">
        {{ __('To continue enjoying uninterrupted access to our services, please renew your subscription before it expires.') }}
    </p>
