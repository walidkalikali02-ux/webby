...
// Custom SVG icons for Google and Facebook
...
export function SocialLoginButtons({ mode = 'login' }: SocialLoginButtonsProps) {
    ...
    const providers = [
        {
            key: 'google',
            enabled: appSettings.google_login_enabled,
            name: 'Google',
            icon: GoogleIcon,
            href: '/auth/google',
        },
        {
            key: 'facebook',
            enabled: appSettings.facebook_login_enabled,
            name: 'Facebook',
            icon: FacebookIcon,
            href: '/auth/facebook',
        },
        {
            key: 'github',
            enabled: appSettings.github_login_enabled,
            name: 'GitHub',
            icon: Github,
            href: '/auth/github',
        },
            ...
            <div className="grid gap-2">
                {enabledProviders.map((provider) => {
                    ...
                    const buttonText = mode === 'login'
                        ...
                        : t('Sign up with :provider', { provider: provider.name });
                    return (
                        <Button
                            key={provider.key}
                            variant="outline"
